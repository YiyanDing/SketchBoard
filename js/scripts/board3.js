...
cvs.addEventListener('touchstart', function(e){
   ...
   addClick(touch.clientX - this.canvas.offsetLeft -modalHead.getBoundingClientRect().left-modalHead.getBoundingClientRect().left, touch.clientY - modalBody.getBoundingClientRect().top - this.canvas.offsetTop);
