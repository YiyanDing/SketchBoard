...
cvs.addEventListener('touchstart', function(e){
    ...
    addClick(touch.clientX - this.offsetLeft  - modalHead.getBoundingClientRect().left - modalHead.getBoundingClientRect().left, touch.clientY - this.offsetTop - - modalBody.getBoundingClientRect().top);
